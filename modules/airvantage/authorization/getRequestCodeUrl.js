 ...
 * All further requests will be made on behalf of a given Airvantage user who authorized the 
 * app to access her Airvantage data. The value of the username parameter does not have to be
 * the one of the user's Airvantage account
 */
...
try {
  ...
  var urlConfig = config.getAirvantageAuthUrl;
  ...
  // associate the state to the provided config.client_id in order to further map the access token to that user
  storage.global["Airvantage_state_" + state]= config.client_id;
